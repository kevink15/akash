...
object Test{
  ...
  def main(args: Array[String])
  {
    ...
    if(i== (-1))
      println("Element not found in Iterative Binary Search.")
    if(k== (-1))
      println("Element not found in Recursive Binary Search.")
  	if(i== (-1) && k== (-1))
    		println("\nElement Not Found");
  	else
    		println("\nElement found at position "+ (i+1)+" using both Iterative and Recursive Binary Search.");
  }
